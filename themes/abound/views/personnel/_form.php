...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->hiddenField($model,'module',array('size'=>25,'maxlength'=>25)); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'designationAlias',array('size'=>30,'maxlength'=>30, 'readonly'=>true)); ?>
		<?php echo $form->error($model,'designationAlias'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'name'); ?>
		<?php echo $form->dropDownList($model,'name', Users::listPersonnel()); ?>

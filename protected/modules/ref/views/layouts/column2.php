	...
	<div class="span3">
		<div class="sidebar-nav">
		  ...
		  <?php $this->widget('zii.widgets.CMenu', array(
			...
			'encodeLabel'=>false,
			'items'=>array(
				//array('label'=>'<i class="icon icon-home"></i>  Dashboard', 'url'=>array('/ref'),'itemOptions'=>array('class'=>'')),
				array('label'=>'<i class="icon icon-home"></i> Dashboard', 'url'=>array('/ref/default/index')	),
				array('label'=>'<i class="icon icon-globe"></i> Referrals', 'url'=>array('/ref/referral/admin')	),
				array('label'=>'<i class="icon icon-file"></i> Order of Payment', 'url'=>array('/ref/orderofpayment/admin')	),
				//array('label'=>'<i class="icon icon-briefcase"></i> Packages', 'url'=>array('/ref/package/admin')	),
				array('label'=>'<i class="icon icon-filter"></i> Tests / Calibration', 'url'=>array('/ref/labservice/admin')	),
				//array('label'=>'<i class="icon icon-tasks"></i> Tests for Update', 'url'=>array('/ref/testforupdate/admin')	),
				array('label'=>'<i class="icon icon-user"></i> Customers', 'url'=>array('/ref/customer/admin')	),
				//array('label'=>'<i class="icon icon-book"></i> Sample Templates', 'url'=>array('/ref/samplename/admin')	),
				//array('label'=>'<i class="icon icon-th-list"></i> Accomplishments', 'url'=>array('/ref/accomplishments')	),
				//array('label'=>'<i class="icon icon-th-large"></i> Statistics', 'url'=>array('/ref/statistic/customer')),
				//array('label'=>'<i class="icon icon-list-alt"></i> Reports', 'url'=>array('/ref/report/index')),

 ...
 *
 * The followings are the available columns in table 'customertype':
 * @property integer $id
...
class Customertype extends CActiveRecord
{
	...
	{	
		$response = RestController::getAdminData('customertypes');
		
		return CHtml::listData($response, 'id', 'type');
	}
}

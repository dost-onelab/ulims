...
/**
 * This is the model class for table "requestcode".
 *
 * The followings are the available columns in table 'requestcode':
 * @property integer $id
 ...
 */
class Requestcode extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('requestRefNum, rstl_id, labId, number, year, cancelled', 'required'),
			...
			array('id, requestRefNum, rstl_id, labId, number, year, cancelled', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Requestcode the static model class
	 */

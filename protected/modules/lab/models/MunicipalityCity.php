...
class MunicipalityCity extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'province'	=> array(self::BELONGS_TO, 'Province', 'regionId'),
		
			'barangays' => array(self::HAS_MANY, 'Barangay', 'municipalityCityId'),
		);
	}
	...
	{
		return CHtml::listData(MunicipalityCity::model()->findAll(), 'id', 'name');
	}

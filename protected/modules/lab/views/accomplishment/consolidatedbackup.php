...
<?php	  
	  $this->widget('zii.widgets.CMenu',array(
				'items'=>array(
					array('label'=>'CHEMLAB', 'url'=>array('/accomplishment/consolidated/1')),
					array('label'=>'MICROLAB', 'url'=>array('/accomplishment/consolidated/2')),
					array('label'=>'METROLAB', 'url'=>array('/accomplishment/consolidated/3')),
				),
			));
?>
</div>
...
<table id="consolidated" style="{border: 1px solid #000;}">
  ...
  <tr>
    <th><div align="center"><?php echo date('Y');?></div></th>
  ...
  <tr>
    <td class="month"><div align="center"><?php echo CHtml::link(date('M',mktime(0, 0, 0, $month, 1, 2013)), $this->createUrl('accomplishment/summary',array('labId'=>$lab->id, 'month'=>$month,'year'=>date('Y'))));?></div></td>

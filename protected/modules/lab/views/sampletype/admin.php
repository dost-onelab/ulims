...
$('.search-form form').submit(function(){
	$('#sampletype-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'testCategoryId',
			'value'=>'$data->testCategories->categoryName',
	...
	'selectableRows'=>1,
	'selectionChanged'=>'function(id){location.href = "'.$this->createUrl('sampletype/view/id').'/"+$.fn.yiiGridView.getSelection(id);}',	
)); ?>

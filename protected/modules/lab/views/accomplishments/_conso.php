...
<table id="consolidated" style="{border: 1px solid #000;}">
  ...
  <tr>
    <td class="month">
    	<div align="center">
    		<?php //echo CHtml::link(date('M',mktime(0, 0, 0, $month, 1, $_SESSION['year'])), $this->createUrl('accomplishments/summary', array('labId'=>$lab->id, 'month'=>$month,'year'=>date('Y'))));?>
    		<?php echo CHtml::link(date('M',mktime(0, 0, 0, $month, 1, $_SESSION['year'])), $this->createUrl('accomplishments/exportSummary', array('labId'=>$lab->id, 'month'=>$month))); ?>
    	</div>
    	<div align="center">
    	<?php //echo CHtml::link($summaryImage, $this->createUrl('accomplishments/exportSummary', array('labId'=>$lab->id, 'month'=>$month))); ?>
    	</div>	
    </td>

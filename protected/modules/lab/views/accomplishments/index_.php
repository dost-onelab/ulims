				...
				array(
			   		'onchange'=>'js:{
								...
								var year = $("#year").val();
			   					...
			   					$("a.export").attr("href","accomplishments/exportConso/year/"+year);
			   					}',
				)
	);
?>
...
?>
<?php echo ' '.CHtml::link('Export',$this->createUrl('accomplishments/exportConso/',array('year'=>$year)), array('class'=>'export'));?>
<?php $this->endWidget(); ?>
</div>		 

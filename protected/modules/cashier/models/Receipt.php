...
class Receipt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, rstl_id, receiptId, receiptDate, paymentModeId, payor, collectionType, bank, check_money_number, checkdate, total, project, cancelled, orderofpayment_id, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'totalCollection' => array(self::STAT, 'Collection', 'receipt_id', 'select'=> 'SUM(amount)', 'condition'=>'cancelled=0'),

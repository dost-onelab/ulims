	...
	echo CHtml::dropDownList('month', abs($month),	
				...
				array(
			   		'onchange'=>'js:{
								...
								var year = $("#year").val();
			   					$(".m-y").text(monthText+" "+year);
			   					$("a.btn").attr("href","exportCashReceiptsRecord/year/"+year+"/month/"+month);
			   					}',
				)
	);
?>

<?php echo CHtml::link('<span class="icon-white icon-print export"></span> Print', $this->createUrl('deposit/exportCashReceiptsRecord',array('year'=>$year, 'month'=>$month)), array('class'=>'btn btn-info'));?>
<?php $this->endWidget(); ?>
</div>    
</fieldset>
...
<thead style="padding-top:5px;">
	<tr >
    	<th>
			<font size="+3">CASH RECEIPTS RECORD</font><br />
	 ...
	 $this->widget('zii.widgets.grid.CGridView', array(
	      ...
	      'columns' => array(
	        ...
	        array(
	        	...
	        	//'headerHtmlOptions' => array('rowspan' => 2),
	        	'htmlOptions' => array('style' => 'text-align: right; padding-right: 20px;'),
	        	'value'=>'Yii::app()->format->formatNumber($data->deposit->amount)',
	        	'footer'=>Yii::app()->format->formatNumber($deposit->getDepositTotal($year, $month)),
	        	'footerHtmlOptions' => array('style' => 'text-align: right; padding-right: 20px;'),
	        ),
	        array(
	        	'name'=>'undeposited', 
	        	'header'=>'UNDEPOSITED<br/>COLLECTION',
	        	//'headerHtmlOptions' => array('rowspan' => 2),
	        	'htmlOptions' => array('style' => 'text-align: right; padding-right: 20px;'),
	        	//'value'=>'($data->project == 0) ? Yii::app()->format->formatNumber($data->totalCollection) : "-"',
	        	//'footer'=>Yii::app()->format->formatNumber(Receipt::getCollectionBtrTotal($year, $month)),

...
class Receipt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, rstl_id, receiptId, receiptDate, paymentModeId, payor, collectionType, bank, check_money_number, checkdate, total, project, cancelled, orderofpayment_id', 'safe', 'on'=>'search'),
		);
	}

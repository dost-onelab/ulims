...
class Customer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('customerName, head, address, tel, fax, email, typeId, natureId, industryId', 'required'),
			...
			array('id, customerName, head, address, municipalitycity_id, barangay_id, tel, fax, email, typeId, natureId, industryId, created', 'safe', 'on'=>'search'),
		);
	}

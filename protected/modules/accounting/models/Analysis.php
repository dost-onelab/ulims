...
class Analysis extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, requestId, sample_id, sampleCode, testName, method, references, quantity, fee, testId, analysisMonth, analysisYear, cancelled, deleted, package', 'safe', 'on'=>'search'),
		);
	}
	...
	protected function afterSave(){
		...
		/*
		$total = 0;
		$request = Request::model()->findByPk($this->sample->request->id);

...
<?php $this->beginContent('//layouts/main'); ?>
  ...
  <div class="row-fluid">
	<div class="span3">
		...
		?>
        <!--/div-->
        <?php $defaultImgAccounting=CHtml::image(Yii::app()->request->baseUrl.'/images/iso9001-2008certified.png','accounting-sidebar-image');echo Yii::app()->params['Accounting']['sidebarImage']?CHtml::image(Yii::app()->request->baseUrl .'/images/'.Yii::app()->params['Accounting']['sidebarImage'],'accounting-sidebar-image',array('class'=>'sidebar-image')):$defaultImgAccounting;?>
        </div>

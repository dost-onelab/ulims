...
class BankaccountController extends Controller
{
			...
			if($model->save())
				...
				if (Yii::app()->request->isAjaxRequest)
                {
                    echo CJSON::encode(array(
                        'status'=>'success', 
                        'div'=>"Account successfully added"
                        ));
                    exit;               
                }
                else
	...
	{	
		if(isset($_POST['Bankaccount']['id'])){
			$id=$_POST['Bankaccount']['id'];
		}else{
			if(isset($_POST['id']))
			$id=$_POST['id'];
		}
		...
		if(isset($_POST['Bankaccount']))
		{
			...
			if($model->save()){
				if (Yii::app()->request->isAjaxRequest)
				{
					echo CJSON::encode(array(
                        'status'=>'success', 
                        'div'=>"Account successfully updated"
                        ));
	 ...
	 * @param Bankaccount $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bankaccount-form')
		{

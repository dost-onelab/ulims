...
* @version 0.1
 */
class PrintEvacueesBehavior extends CBehavior
{
	...
	public function toExcel($model=null, $columns=array(), $title=null, $documentDetails=array(), $exportType='Excel2007')
	{
		...
		if(! $this->owner instanceof CController){
			Yii::log('PrintEvacueesBehavior can only be attached to an instance of CControler', 'error', 'system.base.CBehavior');
			return;
		}
		...
		$this->owner->widget('ext.eexcelview.PrintEvacueesView', $arg);

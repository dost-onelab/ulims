...
class Users extends CActiveRecord
{
	...
	public static function listPersonnel()
	{
		$users = Users::model()->with(array(
					...
					'authassignment'=>array(
						'condition'=>'authassignment.itemname = :itemname OR authassignment.itemname = :itemname2 OR authassignment.itemname = :itemname3',
						'params'=>array(':itemname'=>'Lab - System Manager', ':itemname2'=>'Cashier', ':itemname3'=>'Accounting - Manager')
					),
					))->findAll(array('condition'=>'t.status = 1'));
